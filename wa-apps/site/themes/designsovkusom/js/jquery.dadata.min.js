...
!function (a) {
    ...
    function b(b, c) {
        var d = this;
        d.element = b, d.el = a(b), d.suggestions = [], d.badQueries = [], d.selectedIndex = -1, d.currentValue = d.element.value, d.intervalId = 0, d.cachedResponse = {}, d.enrichmentCache = {}, d.currentRequest = null, d.inputPhase = a.Deferred(), d.dataPhase = a.Deferred(), d.onChangeTimeout = null, d.triggering = {}, d.$wrapper = null, d.options = a.extend({}, k, c), d.classes = {
        ...
        }, d.selection = null, d.$viewport = a(window), d.type = null, d.initialize(), d.setOptions(c)
    }
    ...
    var c = {
        ...
        return {
            matchByNormalizedQuery: function (b, c) {
                var d = b.toLowerCase(), e = this.STOPWORDS, f = m.normalize(d, e), g = [];
                ...
                var e, f = this.STOPWORDS, g = c.toLowerCase(), h = -1;
                return b(d) && (e = m.withSubTokens(m.getWords(g, f)), a.each(d, function (a, b) {
                    ...
                    return 0 === m.arrayMinus(e, d).length ? (h = a,!1
                    ):
                    void 0
                })), h
            }, matchByFields: function (b, c) {
                var d = this.STOPWORDS, e = this.fieldsStopwords, f = m.withSubTokens(m.getWords(b.toLowerCase(), d)), g = [];
    ...
    !function () {
        ...
        d.NAME = {
            ...
            fieldsStopwords: {value: null, "data.address.value": f, "data.inn": null},
            matchers: [n.matchByFields],
            urlSuffix: "party",
            ...
            innPartsLength: {LEGAL: [2, 2, 5, 1], INDIVIDUAL: [2, 2, 6, 2]},
            formatResultInn: function (b, c) {
                var d, e, f = this, g = b.data && b.data.inn, h = f.type.innPartsLength[b.data && b.data.type], i = /\d/;
                return g ? (e = f.highlightMatches(g, c, b), h
                &&
                (e = e.split(""), d = a.map(h, function (a) {
                    for (var b, c = ""; a && (b = e.shift());)c += b, i.test(b) && a--;
                    return c
                }), e = d.join('<span class="' + f.classes.subtext_delimiter + '"></span>') + e.join("")), e
                ):
                void 0
            }
        }, d.EMAIL = {
    ...
    b.utils = m, b.defaultOptions = k, b.version = "15.2.6", a.Suggestions = b, b.prototype = {
        initialize: function () {
            var a = this;
            ...
            var b = this;
            b.$wrapper = a('<div class="suggestions-wrapper"/>'), b.el.after(b.$wrapper), b.$wrapper.add(b.options.$helpers).on("mousedown" + e, a.proxy(b.onMousedown, b))
            ...
            b.preventDefault(), c.cancelBlur = !0, m.delay(function () {
                delete c.cancelBlur
            }), a(b.target).closest(".ui-menu-item").length || m.delay(function () {
            ...
            var b = this;
            b.$viewport.on("resize" + e + b.uniqueId, a.proxy(b.fixPosition, b))
        }, unbindWindowEvents: function () {
            this.$viewport.off("resize" + e + this.uniqueId)
            ...
            var b, c, d = this, e = {};
            d.isMobile = d.$viewport.width() <= d.options.mobileWidth, d.notify("resetPosition"), d.el.css("paddingLeft", ""), d.el.css("paddingRight", ""), e.paddingLeft = parseFloat(d.el.css("paddingLeft")), e.paddingRight = parseFloat(d.el.css("paddingRight")), a.extend(e, d.el.offset()), e.borderTop = "none" == d.el.css("border-top-style") ? 0 : parseFloat(d.el.css("border-top-width")), e.borderLeft = "none" == d.el.css("border-left-style") ? 0 : parseFloat(d.el.css("border-left-width")), e.innerHeight = d.el.innerHeight(), e.innerWidth = d.el.innerWidth(), e.outerHeight = d.el.outerHeight(), e.componentsLeft = 0, e.componentsRight = 0, b = d.$wrapper.offset(), c = {
                top: e.top - b.top,
                left: e.left - b.left
            }, d.notify("fixPosition", c, e), e.componentsLeft > e.paddingLeft && d.el.css("paddingLeft", e.componentsLeft + "px"), e.componentsRight > e.paddingRight && d.el.css("paddingRight", e.componentsRight + "px")
        }, clearCache: function () {
            ...
            var b = this;
            b.dataPhase = b.getSuggestions(a).done(function (c) {
            ...
            return c.abortRequest(), c.currentRequest = d, c.notify("request"), d.always(function () {
                c.currentRequest = null, c.currentRequestIsEnrich = !1, c.notify("request")
            }), d
            ...
            var c = this, d = -1;
            return "" !== a.trim(b) && a.each(c.type.matchers, function (a, e) {
                return d = e.call(c.type, b, c.suggestions), -1 === d
            }), d
        }
    }, function () {
        var d = {
            bindElementEvents: function () {
                ...
                var a = this;
                return a.cancelBlur ? void delete a.cancelBlur : (a.selectCurrentValue({
                    trim: !0,
                    noSpace: !0
                }).done(function () {
                    a.hide()
                }), void(a.currentRequestIsEnrich || a.abortRequest()))
                ...
                if (!b.disabled)if (b.visible) {
                    switch (a.which) {
                        ...
                        case c.SPACE:
                            return void(b.options.triggerSelectOnSpace && b.isCursorAtEnd() && (a.preventDefault(), b.selectCurrentValue({
                                ...
                                -1 === a && (b.currentValue += " ", b.el.val(b.currentValue), b.update())
                            })));
                        case c.UP:
                            b.moveUp();
                            break;
                    ...
                    case c.DOWN:
                        ...
                        break;
                    case c.ENTER:
                        b.triggerOnSelectNothing()
                }
            }, onElementKeyUp: function (b) {
                var d = this;
                if (!d.disabled) {
                    switch (b.which) {
                        case c.UP:
                    ...
                    clearTimeout(d.onChangeTimeout), d.inputPhase.reject(), d.currentValue !== d.el.val() && (d.inputPhase = a.Deferred().done(a.proxy(d.onValueChange, d)), d.options.deferRequestBy > 0 ? d.onChangeTimeout = m.delay(function () {
                        d.inputPhase.resolve()
                    }, d.options.deferRequestBy) : d.inputPhase.resolve())
                }
                ...
                return "number" == typeof d ? d === c : document.selection ? (a = document.selection.createRange(), a
                .
                moveStart("character", -c), c === a.text.length
                ):
                !0
        ...
        var c = {
            enrichSuggestion: function (b, c) {
                ...
                return !d.options.useDadata || !d.type.enrichmentEnabled || !e || c && c.dontEnrich ? f.resolve(b) : b.data && null != b.data.qc ? f.resolve(b) : (d.disableDropdown(), d.currentValue = b.value, d.currentRequestIsEnrich = !0, d.getSuggestions(b.value, {count: 1}, {
                    noCallbacks: !0,
        ...
        var g = {
            createContainer: function () {
                ...
                b.$container = f, b.$wrapper.append(f), "auto" !== d.width && f.width(d.width), f.on("click" + e, c, a.proxy(b.onSuggestionClick, b))
                ...
                var c = this;
                c.$container.toggleClass(c.classes.mobile, c.isMobile).css(c.isMobile ? {
                    left: a.left - b.left + "px",
                    top: a.top + b.outerHeight + "px",
                    width: c.$viewport.width() + "px"
                } : {
                    left: a.left + "px",
                    top: a.top + b.borderTop + b.innerHeight + "px",
                    width: ("auto" === c.options.width ? c.el.outerWidth() : c.options.width) + "px"
                }), c.containerItemsPadding = b.left + b.borderLeft + b.paddingLeft
                ...
                !b.isMobile && c.hint && b.suggestions.length && f.push('<div class="' + b.classes.hint + '">' + c.hint + "</div>"), b.selectedIndex = -1, a.each(b.suggestions, function (a, c) {
                    ...
                    c == b.selection && (b.selectedIndex = a), f.push('<div class="' + b.classes.suggestion + '" data-index="' + a + '">' + d.call(b, c.value, b.currentValue, c, {unformattableTokens: b.type.STOPWORDS})), e && f.push('<span class="' + b.classes.subtext_label + '">' + m.escapeHtml(e) + "</span>"), f.push("</div>")
                }), b.$container.html(f.join("")), c.autoSelectFirst && -1 === b.selectedIndex && (b.selectedIndex = 0), -1 !== b.selectedIndex && b.getSuggestionsItems().eq(b.selectedIndex).addClass(b.classes.selected), a.isFunction(e) && e.call(b.element, b.$container), b.$container.show(), b.visible = !0, b.setItemsPositions()
                ...
                for (n = 0; n < r.length; n++)o = r[n], o.matchable && !o.matched && -1 === a.inArray(o.formatted, s) && a.each(k, function (a, b) {
                    ...
                    before && (r.splice(n, 0, {
                        ...
                        text: o.text.substr(c),
                        formatted: o.formatted.substr(c)
                    }), o.text = o.text.substr(0, c), o.formatted = o.formatted.substr(0, c)), o.matched = !0, !1
                    ):
                    void 0
                });
                if (t) {
                ...
                return !d.dropdownDisabled && (c = d.getSuggestionsItems(), c.removeClass(e), d.selectedIndex = a, -1 !== d.selectedIndex && c.length > d.selectedIndex) ? (b = c.eq(d.selectedIndex), b
                .
                addClass(e), b
                ):
                null
                ...
                f && f.length && (b = f.position().top, 0 > b ? e.$container.scrollTop(g + b) : (c = b + f.outerHeight(), d = e.$container.innerHeight(), c > d && e.$container.scrollTop(g - d + c)
                ),
                e.el.val(e.suggestions[a].value)
                )
            }
        };
        a.extend(b.prototype, g), l.on("initialize", g.createContainer).on("fixPosition", g.setDropdownPosition).on("fixPosition", g.setItemsPositions).on("assignSuggestions", g.suggest)
    }(), function () {
        ...
        var e = {
            ...
            createConstraints: function () {
                ...
                return d ? void(d instanceof a || "string" == typeof d || "number" == typeof d.nodeType ? (b = a(d), b.is(c.constraints) || (c.unbindFromParent(), b.is(c.el) || (c.constraints = b, c.bindToParent()))
                ):
                (c._constraintsUpdating = !0, a.each(c.constraints, a.proxy(c.removeConstraint, c)), a.each(a.makeArray(d), function (a, b) {
                    c.addConstraint(b)
                }), c._constraintsUpdating = !1, c.fixPosition())
                ):
                void c.unbindFromParent()
                ...
                return g instanceof a ? (d = c(d), d
                &&
                (h.locations = [d], h.restrict_value = !0)
                ):
        ...
        var c = {
            proceedQuery: function (a) {
                ...
                return c.inputPhase.resolve(), c.dataPhase.done(function () {
                    d.resolve(c.doSelectCurrentValue(b))
                }), d
            }, doSelectCurrentValue: function (b) {
                var c, d = this, e = d.selectedIndex, f = b && b.trim;
                return -1 === e && (c = d.el.val(), f && (c = a.trim(c)), e = d.findSuggestionIndex(c)), d.select(e, b), e
            }, select: function (b, c) {

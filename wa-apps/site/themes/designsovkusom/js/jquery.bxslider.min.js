...
!function (t) {
    ...
    t.fn.bxSlider = function (n) {
        ...
        var a = t(window).width(), l = t(window).height(), d = function () {
            ...
            r.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'), o.viewport = r.parent(), o.loader = t(), o.viewport.prepend(o.loader), r.css({
            ...
            .
                pagerEl.addClass("bx-custom-pager")
            ):
                (n = s + 1, o
            .
                pagerEl.addClass("bx-default-pager")
            ),

...
$(function () {
    ...
    $("#product-skus input:radio").click(function () {
        if ($(this).data('image-id')) {
            var href = $("#product-image-" + $(this).data('image-id')).attr('href');
            var img = $("#product-image-" + $(this).data('image-id')).data('small');
            console.log($("#product-image-" + $(this).data('image-id')));
        ...
        //var cur_elem = $('#product-skus input:radio:checked').parent('#product-skus > li > label');
        //var notcur_elem = $('#product-skus input:radio:not(:checked)').parent('#product-skus > li > label');
        ...
        //$(cur_elem).find('img').css('border', '2px solid #f4731e');
        //$(notcur_elem).find('img').css('border', 'none');

        $(cur_elem_name).find('.sku_total').css('border', '2px solid #f4731e');
        $(notcur_elem_name).find('.sku_total').css('border', '2px solid white');

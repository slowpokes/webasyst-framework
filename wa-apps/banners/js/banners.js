...
function bannersInitBanner(element){
    var slides = element.find('.banners_slide');
    ...
    function showSlide(next){
        var current = element.find(".banners_slide.current");
        element.find('.banners_navigation > a.current').removeClass('current');
    ...
    function showSlideById(id){
        if(!animation_process){
            ...
            element.find('.banners_navigation > a').eq(id).addClass('current');
        }
    }
    ...
    function addArrows(){
        if(arrow_buttons_size!='none'){
            var link_prev = $('<a href="#" class="banners_arrow banners_arrow_prev"> </a>');
            var link_next = $('<a href="#" class="banners_arrow banners_arrow_next"> </a>');
    ...
    function addNavigation(){
        if(navigation_size!='none'){
            var navigation_block = $('<div class="banners_navigation"></div>');
    ...
    element.find(".banners_slide:first-child").addClass('current');
    setSlideTimer();
    addArrows();
    addNavigation();
    addHover();

...
class bannersBanner
{
    ...
    public function __construct($id){
        ...
        $this->model = new bannersBannerModel();
        $this->getInfo();
    }
    ...
    public function getImages($enabled = false){
        ...
        foreach($images as &$image){
            bannersImage::processImageInfo($this, $image);
        }
        return $images;
    }
    ...
    public function addView(){
        if(wa()->getEnv()=='frontend'){
            $click_model = new bannersViewModel();
    ...
    public function getCTR(){
        $views_model = new bannersViewModel();
        $clicks_model = new bannersClickModel();
        $images_model = new bannersImageModel();
        ...
        $sql = 'SELECT image_id, count(id) as c FROM `banners_click` where image_id IN ('.implode(',', array_keys($images)).') group by image_id';
    ...
    public static function getFolder($banner_id){
        ...
        $path = 'banners/'.substr($str, -2).'/'.substr($str, -4, 2)."/$banner_id/";
        return $path;
    }
